...
class SitemapGeneratorServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'sitemap-generator');
        ...
        if ($this->app->runningInConsole()) {
            $this->publishes([
                __DIR__.'/../config/config.php' => config_path('sitemap-generator.php'),
            ], 'config');
            ...
            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/sitemap-generator'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/sitemap-generator'),
            ], 'lang');*/
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/config.php', 'sitemap-generator');
